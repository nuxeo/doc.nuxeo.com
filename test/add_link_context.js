...
test('add_link_context returns page links (without version) as expected', function (assert) {
    ...
    const string_tests = [
        ...
        },
        {
            ...
            expected: "String contains {{file name='image.png' page='authentication-and-user-management' space='nxdoc'}} picture",
        ...
        },
        {
            ...
            expected: "String contains {{file name='image1.png' page='authentication-and-user-management' space='nxdoc'}}{{file name='image2.png' page='authentication-and-user-management' space='nxdoc'}} picture",
...
test('add_link_context returns page links (with version) as expected', function (assert) {
    ...
    const string_tests = [
        ...
        {
            test    : "String contains {{file name='image.png'}} picture",
            expected: "String contains {{file name='image.png' page='authentication-and-user-management' space='nxdoc' version='710'}} picture",
            message : 'returns file link with context added'
        },
        {
            test    : "String contains {{page page='installation' space='admindoc'}} link",
        ...
        {
            test    : "String contains {{file name='image1.png'}}{{file name='image2.png'}} picture",
            expected: "String contains {{file name='image1.png' page='authentication-and-user-management' space='nxdoc' version='710'}}{{file name='image2.png' page='authentication-and-user-management' space='nxdoc' version='710'}} picture",
            message : 'returns file links with context added'
        }
    ];
